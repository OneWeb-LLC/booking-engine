...
### Core Booking Engine Recoveries
...
### Connected downstream recoveries

- Conversion Recovery
- Payment Recovery
- Onboarding Recovery

Downstream recoveries remain documented to preserve handoff integrity, but they are not part of the core Booking Engine deliverable.
