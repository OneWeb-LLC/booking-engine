...
| Campaign Manager | Live Calls → Assigned Tasks | Accepted escalations, coverage intervention, QA and coaching work |
| Snapshot Maintainer | Assigned Tasks | Configuration, verification, incident and change-control work |
...
- Ordinary callback or retry → Call Queue.
- Personally owned follow-up without a mutually scheduled customer commitment → Assigned Task.
- Mutually agreed exact date and time → callback appointment.
