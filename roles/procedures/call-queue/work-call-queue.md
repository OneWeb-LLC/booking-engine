...
- **Salesflow dependency:** Core Manual Actions plus client-configured queue workflows
...
2. Notify the Campaign Manager or Campaign Manager through the approved channel.
