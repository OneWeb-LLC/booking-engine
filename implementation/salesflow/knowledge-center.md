...
- Clear escalation action at the bottom of every procedure.
- Version and Last verified metadata visible but unobtrusive.

## Course experience

Use the Salesflow course for structured onboarding, demonstrations, quizzes, certification, and update lessons. Link each lesson to the same canonical procedure used by the Knowledge Center.
...
- Never paste an external vendor article as an employee procedure.
...
- Re-verify procedures after interface, permission, workflow, or routing changes.
