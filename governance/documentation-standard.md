...
| Operating path | Standard, Expedited, or Recovery movement |
...
| Note | Historical context worth preserving |

## Note standard

Do not generate narrative notes for every automated event. Notes should preserve information a future human genuinely needs, such as motivation, objections, preferences, decision-makers, commitments, and unusual circumstances.

## Universal completion rule

Every call must create clarity by doing at least one of the following:
